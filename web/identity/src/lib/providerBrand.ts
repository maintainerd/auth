 ...
 *
 * Mirrors the console's providerBrand map so a provider looks the same in the
 * admin console and on the identity app's login form. Uses the brand icons
 * shipped with @tabler/icons-react. Monochrome brands (GitHub, X) use
 * `text-foreground` so they stay legible in light and dark themes.
