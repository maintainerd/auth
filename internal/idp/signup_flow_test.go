...
func buildSignupFlow() *SignupFlow {
	return &SignupFlow{
		SignupFlowID:   1,
...
func TestSignupFlowService_GetByUUID(t *testing.T) {
	...
	t.Run("not found (nil)", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) { return nil, nil },
	...
	t.Run("repo error", func(t *testing.T) {
		db, _ := newMockGormDB(t)
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) {
	...
	t.Run("success", func(t *testing.T) {
		db, _ := newMockGormDB(t)
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) { return sf, nil },
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, defaultCR())
...
func TestSignupFlowService_GetAll(t *testing.T) {
	...
	t.Run("success without ClientUUID", func(t *testing.T) {
		db, _ := newMockGormDB(t)
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findPaginatedFn: func(_ SignupFlowRepositoryGetFilter) (*PaginationResult[SignupFlow], error) {
				return &PaginationResult[SignupFlow]{Data: []SignupFlow{*sf}, Total: 1, Page: 1, Limit: 10, TotalPages: 1}, nil
			},
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, defaultCR())
	...
	t.Run("with ClientUUID → success", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findPaginatedFn: func(f SignupFlowRepositoryGetFilter) (*PaginationResult[SignupFlow], error) {
...
func TestSignupFlowService_Create(t *testing.T) {
	...
	t.Run("client not found", func(t *testing.T) {
		...
		cr.findByUUIDFn = func(_ any, _ ...string) (*Client, error) { return nil, nil }
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, cr)
		_, err := svc.Create(context.Background(), 1, "test-flow", "desc", nil, shared.StatusActive, clientUUID)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "auth client not found")
	})
	...
	t.Run("FindByName error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByNameFn: func(_ string) (*SignupFlow, error) { return nil, errors.New("name err") },
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, cr)
		_, err := svc.Create(context.Background(), 1, "test-flow", "desc", nil, shared.StatusActive, clientUUID)
		require.Error(t, err)
	...
	t.Run("name already exists", func(t *testing.T) {
		...
		cr.findByUUIDFn = func(_ any, _ ...string) (*Client, error) { return &Client{ClientID: 1}, nil }
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByNameFn: func(_ string) (*SignupFlow, error) { return &SignupFlow{Name: "test-flow"}, nil },
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, cr)
		_, err := svc.Create(context.Background(), 1, "test-flow", "desc", nil, shared.StatusActive, clientUUID)
		require.Error(t, err)
	...
	t.Run("FindByIdentifierAndClientID error", func(t *testing.T) {
		...
		cr.findByUUIDFn = func(_ any, _ ...string) (*Client, error) { return &Client{ClientID: 1}, nil }
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByNameFn: func(_ string) (*SignupFlow, error) { return nil, nil },
			findByIdentifierAndClientIDFn: func(_ string, _ int64) (*SignupFlow, error) {
	...
	t.Run("config marshal error", func(t *testing.T) {
		...
		_, err := svc.Create(context.Background(), 1, "test-flow", "desc", map[string]any{"bad": math.Inf(1)}, shared.StatusActive, clientUUID)
		require.Error(t, err)
	})
	...
	t.Run("Create repo error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByNameFn: func(_ string) (*SignupFlow, error) { return nil, nil },
			createFn:     func(_ *SignupFlow) (*SignupFlow, error) { return nil, errors.New("create err") },
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, cr)
		_, err := svc.Create(context.Background(), 1, "test-flow", "desc", nil, shared.StatusActive, clientUUID)
		require.Error(t, err)
	...
	t.Run("success with nil config", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByNameFn: func(_ string) (*SignupFlow, error) { return nil, nil },
			createFn:     func(e *SignupFlow) (*SignupFlow, error) { return sf, nil },
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) {
				return sf, nil
			},
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, cr)
		res, err := svc.Create(context.Background(), 1, "test-flow", "desc", nil, shared.StatusActive, clientUUID)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
	...
	t.Run("success with config", func(t *testing.T) {
		...
		res, err := svc.Create(context.Background(), 1, "test-flow", "desc", map[string]any{"key": "val"}, shared.StatusActive, clientUUID)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
}
...
func TestSignupFlowService_Update(t *testing.T) {
	...
	t.Run("not found", func(t *testing.T) {
		...
		_, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, "new", "desc", nil, shared.StatusActive)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "signup flow not found")
	})
	...
	t.Run("name change → FindByName error", func(t *testing.T) {
		...
		_, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, "different-name", "desc", nil, shared.StatusActive)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "name err")
	})
	...
	t.Run("name change → conflict with different flow", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) { return sf, nil },
			findByNameFn: func(_ string) (*SignupFlow, error) {
				return &SignupFlow{SignupFlowID: 999, Name: "different-name"}, nil
			},
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, defaultCR())
		_, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, "different-name", "desc", nil, shared.StatusActive)
		require.Error(t, err)
	...
	t.Run("name change → same flow found (no conflict)", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) { return sf, nil },
			findByNameFn: func(_ string) (*SignupFlow, error) {
				return &SignupFlow{SignupFlowID: sf.SignupFlowID}, nil // same ID → no conflict
			},
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, defaultCR())
		res, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, "different-name", "desc", nil, shared.StatusActive)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
	...
	t.Run("same name (no change) → skip name check", func(t *testing.T) {
		...
		res, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, sf.Name, "desc", nil, shared.StatusActive)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
	...
	t.Run("config marshal error", func(t *testing.T) {
		...
		_, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, sf.Name, "desc", map[string]any{"bad": math.Inf(1)}, shared.StatusActive)
		require.Error(t, err)
	})
	...
	t.Run("CreateOrUpdate error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			findByUUIDAndTenantIDFn: func(_ uuid.UUID, _ int64, _ ...string) (*SignupFlow, error) { return sf, nil },
			createOrUpdateFn: func(_ *SignupFlow) (*SignupFlow, error) {
				return nil, errors.New("update err")
			},
		}, &mockSignupFlowRoleRepo{}, &mockRoleRepo{}, defaultCR())
		_, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, sf.Name, "desc", nil, shared.StatusActive)
		require.Error(t, err)
	...
	t.Run("success with config", func(t *testing.T) {
		...
		res, err := svc.Update(context.Background(), sf.SignupFlowUUID, 1, sf.Name, "desc", map[string]any{"k": "v"}, shared.StatusActive)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
}
...
func TestSignupFlowService_UpdateStatus(t *testing.T) {
	...
	t.Run("not found", func(t *testing.T) {
		...
		_, err := svc.UpdateStatus(context.Background(), sf.SignupFlowUUID, 1, shared.StatusInactive)
		require.Error(t, err)
		assert.Contains(t, err.Error(), "signup flow not found")
	})
	...
	t.Run("success", func(t *testing.T) {
		...
		res, err := svc.UpdateStatus(context.Background(), sf.SignupFlowUUID, 1, shared.StatusInactive)
		require.NoError(t, err)
		assert.NotNil(t, res)
	})
}
...
func TestSignupFlowService_AssignRoles(t *testing.T) {
	...
	t.Run("FindBySignupFlowIDAndRoleID error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			...
			findBySignupFlowIDAndRoleIDFn: func(_, _ int64) (*SignupFlowRole, error) {
	...
	t.Run("role already assigned → skip", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			...
			findBySignupFlowIDAndRoleIDFn: func(_, _ int64) (*SignupFlowRole, error) {
				return &SignupFlowRole{SignupFlowRoleID: 99}, nil // already exists
			},
		}, &mockRoleRepo{
			findByUUIDFn: func(_ any, _ ...string) (*Role, error) { return role, nil },
		}, defaultCR())
	...
	t.Run("Create signup flow role error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			...
			createFn: func(_ *SignupFlowRole) (*SignupFlowRole, error) {
...
func TestSignupFlowService_GetRoles(t *testing.T) {
	...
	t.Run("FindBySignupFlowIDPaginated error", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			...
			findBySignupFlowIDPaginatedFn: func(_ int64, _, _ int) ([]SignupFlowRole, int64, error) {
	...
	t.Run("success with nil Role in result", func(t *testing.T) {
		...
		svc := NewSignupFlowService(db, &mockSignupFlowRepo{
			...
			findBySignupFlowIDPaginatedFn: func(_ int64, _, _ int) ([]SignupFlowRole, int64, error) {
				return []SignupFlowRole{{SignupFlowRoleUUID: uuid.New(), Role: nil}}, 1, nil
			},
		}, &mockRoleRepo{}, defaultCR())
