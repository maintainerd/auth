...
type AuthClient struct {
	...
	AuthClientURIs   *[]AuthClientURI  `gorm:"foreignKey:AuthClientID;references:AuthClientID"`
	AuthClientApis   *[]AuthClientApi  `gorm:"foreignKey:AuthClientID;references:AuthClientID"`
}
