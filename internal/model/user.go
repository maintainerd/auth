...
type User struct {
	...
	Username           string     `gorm:"column:username;type:varchar(255);not null;unique;index:idx_users_username"`
	Email              string     `gorm:"column:email;type:varchar(255);not null;unique;index:idx_users_email"`
