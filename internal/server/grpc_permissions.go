...
var grpcServicePermissions = map[string]string{
	...
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "ListSignupFlows"):       "auth-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "GetSignupFlow"):         "auth-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "CreateSignupFlow"):      "auth-flow:create",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "UpdateSignupFlow"):      "auth-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "SetSignupFlowStatus"):   "auth-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "DeleteSignupFlow"):      "auth-flow:delete",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "AssignSignupFlowRoles"): "auth-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "ListSignupFlowRoles"):   "auth-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "RemoveSignupFlowRole"):  "auth-flow:update",
