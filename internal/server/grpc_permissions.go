...
var grpcServicePermissions = map[string]string{
	...
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "ListSignupFlows"):       "signup-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "GetSignupFlow"):         "signup-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "CreateSignupFlow"):      "signup-flow:create",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "UpdateSignupFlow"):      "signup-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "SetSignupFlowStatus"):   "signup-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "DeleteSignupFlow"):      "signup-flow:delete",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "AssignSignupFlowRoles"): "signup-flow:update",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "ListSignupFlowRoles"):   "signup-flow:read",
	grpcMethod(authv1.SignupFlowService_ServiceDesc.ServiceName, "RemoveSignupFlowRole"):  "signup-flow:update",
