...
func TestIPRestrictionRuleGRPCHandler_RPCS(t *testing.T) {
	...
	t.Run("get service error", func(t *testing.T) {
		svc := &testIPRestrictionRuleService{
			getByUUIDFn: func(ctx context.Context, tid int64, id uuid.UUID) (*IPRestrictionRuleServiceDataResult, error) { return nil, errors.New("db") },
		}
		h := NewIPRestrictionRuleGRPCHandler(resolver, svc)
		_, err := h.GetIPRestrictionRule(ctx, &authv1.GetIPRestrictionRuleRequest{TenantUuid: tenantUUID.String(), IpRestrictionRuleUuid: ruleUUID.String()})
		if code := status.Code(err); code != codes.Internal { t.Errorf("expected Internal, got %v", code) }
	...
	t.Run("create service error", func(t *testing.T) {
		svc := &testIPRestrictionRuleService{
			createFn: func(ctx context.Context, tenantID int64, desc, ruleType, ip, status string, cb int64) (*IPRestrictionRuleServiceDataResult, error) { return nil, errors.New("db") },
		}
		h := NewIPRestrictionRuleGRPCHandler(resolver, svc)
	...
	t.Run("update service error", func(t *testing.T) {
		svc := &testIPRestrictionRuleService{
			updateFn: func(ctx context.Context, tenantID int64, id uuid.UUID, desc, ruleType, ip, rs string, ub int64) (*IPRestrictionRuleServiceDataResult, error) { return nil, errors.New("db") },
		}
		h := NewIPRestrictionRuleGRPCHandler(resolver, svc)
	...
	t.Run("setStatus service error", func(t *testing.T) {
		svc := &testIPRestrictionRuleService{
			updateStatusFn: func(ctx context.Context, tenantID int64, id uuid.UUID, rs string, ub int64) (*IPRestrictionRuleServiceDataResult, error) { return nil, errors.New("db") },
		}
		h := NewIPRestrictionRuleGRPCHandler(resolver, svc)
	...
	t.Run("delete service error", func(t *testing.T) {
		svc := &testIPRestrictionRuleService{
			deleteFn: func(ctx context.Context, tenantID int64, id uuid.UUID) (*IPRestrictionRuleServiceDataResult, error) { return nil, errors.New("db") },
		}
		h := NewIPRestrictionRuleGRPCHandler(resolver, svc)
		_, err := h.DeleteIPRestrictionRule(ctx, &authv1.DeleteIPRestrictionRuleRequest{TenantUuid: tenantUUID.String(), IpRestrictionRuleUuid: ruleUUID.String()})
		if code := status.Code(err); code != codes.Internal { t.Errorf("expected Internal, got %v", code) }
	...
	t.Run("resolveTenant resolver error", func(t *testing.T) {
		errResolver := &testSecpolicyTenantResolver{getByUUIDFn: func(ctx context.Context, tuuid uuid.UUID) (*TenantServiceDataResult, error) { return nil, errors.New("tenant") }}
