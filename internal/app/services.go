...
func initServices(db *gorm.DB, r *repos, appCache *cache.Cache) *svcs {
	return &svcs{
		...
		userService:              service.NewUserService(db, r.userRepo, r.userIdentityRepo, r.userRoleRepo, r.roleRepo, r.tenantRepo, r.idpRepo, r.clientRepo, r.tenantUserRepo, appCache),
