...
func NewApp(db *gorm.DB, redisClient *redis.Client) *App {
	...
	setupService := service.NewSetupService(db, userRepo, tenantRepo, tenantMemberRepo, authClientRepo, idpRepo, roleRepo, userRoleRepo, userTokenRepo, userIdentityRepo, profileRepo)
