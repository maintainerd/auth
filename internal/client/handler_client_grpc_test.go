...
type testClientService struct {
	...
	createFn                    func(ctx context.Context, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, identityProviderUUID string, brandingUUID *uuid.UUID, allowRegistration bool, actorUserUUID uuid.UUID) (*ClientCreateServiceResult, error)
	updateFn                    func(ctx context.Context, clientUUID uuid.UUID, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, brandingUUID *uuid.UUID, allowRegistration *bool, actorUserUUID uuid.UUID) (*ClientServiceDataResult, error)
...
func (m *testClientService) Create(ctx context.Context, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, identityProviderUUID string, brandingUUID *uuid.UUID, allowRegistration bool, actorUserUUID uuid.UUID) (*ClientCreateServiceResult, error) {
	return m.createFn(ctx, tenantID, name, displayName, clientType, domain, config, status, isDefault, identityProviderUUID, brandingUUID, allowRegistration, actorUserUUID)
}
func (m *testClientService) Update(ctx context.Context, clientUUID uuid.UUID, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, brandingUUID *uuid.UUID, allowRegistration *bool, actorUserUUID uuid.UUID) (*ClientServiceDataResult, error) {
	return m.updateFn(ctx, clientUUID, tenantID, name, displayName, clientType, domain, config, status, isDefault, brandingUUID, allowRegistration, actorUserUUID)
}
...
func TestClientGRPCHandler_RPCS(t *testing.T) {
	...
	t.Run("create success", func(t *testing.T) {
		svc := &testClientService{
			createFn: func(ctx context.Context, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, ipUUID string, _ *uuid.UUID, _ bool, actor uuid.UUID) (*ClientCreateServiceResult, error) {
	...
	t.Run("update success", func(t *testing.T) {
		svc := &testClientService{
			updateFn: func(ctx context.Context, id uuid.UUID, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, _ *uuid.UUID, _ *bool, actor uuid.UUID) (*ClientServiceDataResult, error) {
				return &clientResult, nil
			},
		}
		h := NewClientGRPCHandler(resolver, svc)
