...
func TestClientGRPCHandler_RPCS(t *testing.T) {
	...
	t.Run("create success", func(t *testing.T) {
		svc := &testClientService{
			createFn: func(ctx context.Context, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, ipUUID string, _ *uuid.UUID, _ bool, _ *string, _ *string, _ *bool, _ *bool, actor uuid.UUID) (*ClientCreateServiceResult, error) {
	...
	t.Run("update success", func(t *testing.T) {
		svc := &testClientService{
			updateFn: func(ctx context.Context, id uuid.UUID, tenantID int64, name, displayName, clientType, domain string, config datatypes.JSON, status string, isDefault bool, _ *uuid.UUID, _ *bool, _ *string, _ *string, _ *bool, _ *bool, actor uuid.UUID) (*ClientServiceDataResult, error) {
				return &clientResult, nil
			},
		}
		h := NewClientGRPCHandler(resolver, svc)
