...
func TestAPIKeyStatusUpdateDto_Validate(t *testing.T) {
	assert.NoError(t, APIKeyStatusUpdateDTO{Status: shared.StatusActive}.Validate())
	assert.NoError(t, APIKeyStatusUpdateDTO{Status: shared.StatusInactive}.Validate())
