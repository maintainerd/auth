...
type WebhookEndpointEvent struct {
	WebhookEndpointEventID   int64     `gorm:"column:webhook_endpoint_event_id;primaryKey;autoIncrement" json:"-"`
	WebhookEndpointEventUUID uuid.UUID `gorm:"column:webhook_endpoint_event_uuid" json:"webhook_endpoint_event_id"`
