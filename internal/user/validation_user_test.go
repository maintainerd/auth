...
func TestUserSetStatusRequestDto_Validate(t *testing.T) {
	assert.NoError(t, UserSetStatusRequestDTO{Status: shared.StatusActive}.Validate())
	assert.NoError(t, UserSetStatusRequestDTO{Status: shared.StatusSuspended}.Validate())
