...
type TenantSetting struct {
	TenantSettingID   int64          `gorm:"column:tenant_setting_id;primaryKey;autoIncrement" json:"-"`
	TenantSettingUUID uuid.UUID      `gorm:"column:tenant_setting_uuid;type:uuid;uniqueIndex;not null" json:"tenant_setting_id"`
