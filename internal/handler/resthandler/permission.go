...
func (h *PermissionHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to fetch permissions", err.Error())
		return
	}
...
func (h *PermissionHandler) GetByUUID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusNotFound, "Permission not found")
		return
	}
...
func (h *PermissionHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to create permission", err.Error())
		return
	}
...
func (h *PermissionHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update auth container", err.Error())
		return
	}
...
func (h *PermissionHandler) SetStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update permission status", err.Error())
		return
	}
...
func (h *PermissionHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to delete auth container", err.Error())
		return
	}
