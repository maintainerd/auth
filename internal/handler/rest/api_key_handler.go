...
func (h *APIKeyHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to fetch API keys", err.Error())
		return
	}
...
func (h *APIKeyHandler) GetByUUID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusNotFound, "API key not found")
		return
	}
...
func (h *APIKeyHandler) GetConfigByUUID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusNotFound, "API key not found", err.Error())
		return
	}
...
func (h *APIKeyHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to create API key", err.Error())
		return
	}
...
func (h *APIKeyHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update API key", err.Error())
		return
	}
...
func (h *APIKeyHandler) SetStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update API key status")
		return
	}
...
func (h *APIKeyHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to delete API key", err.Error())
		return
	}
...
func (h *APIKeyHandler) GetAPIs(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get API key APIs")
		return
	}
...
func (h *APIKeyHandler) AddAPIs(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to add APIs to API key")
		return
	}
...
func (h *APIKeyHandler) RemoveAPI(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to remove API from API key")
		return
	}
...
func (h *APIKeyHandler) GetAPIPermissions(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get API key API permissions")
		return
	}
...
func (h *APIKeyHandler) AddAPIPermissions(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to add permissions to API key API")
		return
	}
...
func (h *APIKeyHandler) RemoveAPIPermission(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to remove permission from API key API")
		return
	}
