...
func (h *SecuritySettingHandler) GetGeneralConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get general config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) GetPasswordConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get password config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) GetSessionConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get session config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) GetThreatConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get threat config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) GetIPConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get IP config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) UpdateGeneralConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Failed to update general config", err.Error())
		return
	}
	...
	config, err := h.securitySettingService.GetGeneralConfig(tenant.TenantID)
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to get updated config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) UpdatePasswordConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Failed to update password config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) UpdateSessionConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Failed to update session config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) UpdateThreatConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Failed to update threat config", err.Error())
		return
	}
...
func (h *SecuritySettingHandler) UpdateIPConfig(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Failed to update IP config", err.Error())
		return
	}
