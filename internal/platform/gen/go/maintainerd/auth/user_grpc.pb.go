...
const (
	InviteService_SendInvite_FullMethodName = "/maintainerd.auth.v1.InviteService/SendInvite"
)
...
func (c *inviteServiceClient) SendInvite(ctx context.Context, in *SendInviteRequest, opts ...grpc.CallOption) (*SendInviteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendInviteResponse)
	err := c.cc.Invoke(ctx, InviteService_SendInvite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInviteServiceServer) SendInvite(context.Context, *SendInviteRequest) (*SendInviteResponse, error) {
...
func _InviteService_SendInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendInviteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InviteServiceServer).SendInvite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InviteService_SendInvite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InviteServiceServer).SendInvite(ctx, req.(*SendInviteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InviteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "maintainerd.auth.v1.InviteService",
	HandlerType: (*InviteServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendInvite",
			Handler:    _InviteService_SendInvite_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "maintainerd/auth/v1/user.proto",
