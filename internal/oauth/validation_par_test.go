...
func TestOAuthPARRequestDTO_Validate(t *testing.T) {
	cases := []struct {
		...
		{"missing code_challenge", OAuthPARRequestDTO{ResponseType: "code", ClientID: "app", RedirectURI: "https://x.com", CodeChallengeMethod: "S256"}, ""},
		...
		{"missing code_challenge_method", OAuthPARRequestDTO{ResponseType: "code", ClientID: "app", RedirectURI: "https://x.com", CodeChallenge: strings.Repeat("x", 43)}, ""},
