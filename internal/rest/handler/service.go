...
func (h *ServiceHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	resp.Success(w, response, "Services fetched successfully")
}
...
func (h *ServiceHandler) GetByUUID(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Invalid service UUID")
		return
	}
...
func (h *ServiceHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.HandleServiceError(w, r, "Failed to create service", err)
		return
	}
