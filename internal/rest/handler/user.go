...
func (h *UserHandler) CreateUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to create user", err.Error())
		return
	}
...
func (h *UserHandler) UpdateUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update user", err.Error())
		return
	}
...
func (h *UserHandler) SetUserStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to update user status", err.Error())
		return
	}
...
func (h *UserHandler) VerifyEmail(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to verify email", err.Error())
		return
	}
...
func (h *UserHandler) VerifyPhone(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to verify phone", err.Error())
		return
	}
...
func (h *UserHandler) CompleteAccount(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to complete account", err.Error())
		return
	}
...
func (h *UserHandler) DeleteUser(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to delete user", err.Error())
		return
	}
...
func (h *UserHandler) AssignRoles(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to assign roles to user", err.Error())
		return
	}
...
func (h *UserHandler) RemoveRole(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to remove role from user", err.Error())
		return
	}
...
func (h *UserHandler) GetUserRoles(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to fetch user roles", err.Error())
		return
	}
...
func (h *UserHandler) GetUserIdentities(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusInternalServerError, "Failed to fetch user identities", err.Error())
		return
	}
