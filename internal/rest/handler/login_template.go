...
func (h *LoginTemplateHandler) GetAll(w http.ResponseWriter, r *http.Request) {
	...
	resp.Success(w, response, "Login templates retrieved successfully")
}
...
func (h *LoginTemplateHandler) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.Error(w, http.StatusBadRequest, "Invalid login template UUID")
		return
	}
	...
	resp.Success(w, toLoginTemplateResponseDTO(*template), "Login template retrieved successfully")
}
...
func (h *LoginTemplateHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.HandleServiceError(w, r, "Failed to create login template", err)
		return
	}

	resp.Created(w, toLoginTemplateResponseDTO(*template), "Login template created successfully")
}
...
func (h *LoginTemplateHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp.HandleServiceError(w, r, "Failed to update login template", err)
		return
	}

	resp.Success(w, toLoginTemplateResponseDTO(*template), "Login template updated successfully")
}
...
func (h *LoginTemplateHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	resp.Success(w, toLoginTemplateResponseDTO(*template), "Login template deleted successfully")
}
...
func (h *LoginTemplateHandler) UpdateStatus(w http.ResponseWriter, r *http.Request) {
	...
	resp.Success(w, toLoginTemplateResponseDTO(*template), "Login template status updated successfully")
}
