...
func SeedPermissions(db *gorm.DB, apiID int64) error {
	permissions := []model.Permission{
		...
		// Signup Flows
		newPermission("signup-flow:read", "Read signup flows", apiID),
		newPermission("signup-flow:create", "Create signup flow", apiID),
		...
		// Email Templates
		newPermission("email-template:read", "Read email templates", apiID),
		newPermission("email-template:create", "Create email template", apiID),
		newPermission("email-template:update", "Update email template", apiID),
		newPermission("email-template:delete", "Delete email template", apiID),

		// SMS Templates
		newPermission("sms-template:read", "Read SMS templates", apiID),
		newPermission("sms-template:create", "Create SMS template", apiID),
