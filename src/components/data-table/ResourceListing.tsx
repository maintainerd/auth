  ...
  return (
    <div className="space-y-4">
      ...
      {tableInCard ? (
        ...
        // single bottom line.
        <div className="overflow-hidden rounded-[3px] border border-slate-200 bg-white shadow-xs [&_table]:border-b-0 [&_tbody_tr:last-child]:border-b-0 md:[&_td:first-child]:pl-4 md:[&_td:last-child]:pr-4 md:[&_th:first-child]:pl-4 md:[&_th:last-child]:pr-4">
          <DataTable
            table={table}
